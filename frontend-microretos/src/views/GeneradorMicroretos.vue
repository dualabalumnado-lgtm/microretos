    ...
    <div class="max-w-6xl mx-auto">
            ...
            <section class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-10 border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div class="mb-10 relative z-20 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select v-model="centroFiltro" class="input-style border-slate-200 dark:border-slate-700 focus:border-emerald-500">
          ...
          <div v-if="pasoActual === 2" class="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
             <section class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-10 border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
              ...
              <div class="flex items-center gap-4 mb-8">
                ...
                <h2 class="text-2xl font-black uppercase tracking-tight">Realidad de la Empresa</h2>
              </div>
            ...
            <section class="bg-white dark:bg-slate-900 rounded-[2.5rem] p-10 border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="col-span-2 mt-2 pt-6 border-t border-slate-100">
                  <div class="w-full bg-blue-50/50 p-6 rounded-3xl border border-blue-100 relative">
          ...
          <div class="bg-white rounded-xl shadow-2xl mx-auto max-w-5xl overflow-hidden border border-slate-200">
            <div class="bg-slate-50 border-b border-slate-200 p-10 md:px-16 pt-12">
              ...
              <div class="flex flex-wrap gap-3">
                ...
                <span class="flex items-center gap-2 px-4 py-2 border border-slate-300 text-slate-600 rounded-md text-xs font-bold uppercase tracking-wider">
            ...
            <div class="p-10 md:p-16 space-y-12">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                  <h3 class="flex items-center gap-2 text-slate-800 font-bold uppercase text-xs tracking-widest border-b border-slate-200 pb-2 mb-4">
                    <svg class="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    ODS Sugeridos
                  </h3>
                  <ul class="space-y-2 pl-2">
              ...
              <div>
                <h3 class="flex items-center gap-2 text-slate-800 font-bold uppercase text-xs tracking-widest border-b-2 border-slate-800 pb-2 mb-6">
                ...
                <div class="space-y-6">
                  <div v-for="evalObj in reto.evaluacion_oficial" :key="evalObj.modulo" class="bg-white border border-slate-200 p-6 rounded-xl">
                    ...
                    <div class="mb-4">
                      ...
                      <ul class="space-y-2">
                        <li v-for="(ce, i) in evalObj.ce" :key="i" class="text-sm text-slate-600 flex items-start gap-2">
                          <span class="text-emerald-500 font-bold mt-0.5">✓</span> {{ ce }}
                        </li>
                      </ul>
                    </div>
      ...
      <transition name="fade">
        <div v-if="popupActivo" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" @click.self="cerrarPopup">
          <div class="bg-white dark:bg-slate-900 rounded-3xl p-8 max-w-lg w-full shadow-2xl relative">
            <button @click="cerrarPopup" class="absolute top-4 right-4 text-slate-400 hover:text-slate-600"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg></button>
            <div class="flex items-center gap-3 mb-4">
              <div :class="popupActivo.tipo === 'info' ? 'bg-blue-100 text-blue-600' : 'bg-amber-100 text-amber-600'" class="p-3 rounded-xl">
              ...
              <h3 class="text-xl font-black uppercase tracking-tight">{{ popupActivo.tipo === 'info' ? 'Ayuda' : 'Ejemplo' }}</h3>
            </div>
            <p class="text-slate-600 dark:text-slate-300 text-lg leading-relaxed">{{ ayudas[popupActivo.id][popupActivo.tipo] }}</p>
          </div>
        </div>
      </transition>
...
.input-style {
  @apply w-full bg-white border-2 border-slate-200 rounded-3xl p-5 text-sm font-bold text-slate-800 focus:border-emerald-500 focus:bg-white outline-none transition-all placeholder:text-slate-400 disabled:opacity-50 shadow-sm;
}
.label-style {
